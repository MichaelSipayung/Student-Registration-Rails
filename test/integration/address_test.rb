...
class AddressTestAll < ActionDispatch::IntegrationTest
  ...
  test 'should create new address for valid data' do
    ...
    assert_difference 'Address.count' do
      post addresses_path, params: { address: {
        ...
        kode_pos: 12_345, provinsi: 'example', no_telepon: 1_234_567_890, kabupaten: 'example'
      } }
    end
    get new_address_path
    assert_template 'addresses/new'
  ...
  test 'should reject invalid information' do
    ...
    assert_no_difference 'Address.count' do
      post addresses_path, params: { address: {
        alamat: 'malasyia', kelurahan: 'example', kecamatan: 'example',
        kode_pos: 1234, provinsi: 'example', no_telepon: 1_234_567_890, kabupaten: 'example'
      } }
    end
    get new_address_path
    assert_template 'addresses/new'
    assert_no_difference 'Address.count' do # unpermited user_id parameter
      post addresses_path, params: { address: {
        alamat: 'malasyia', kelurahan: 'example', kecamatan: 'example',
        kode_pos: 1234, provinsi: 'example', no_telepon: 1_234_567_890, kabupaten: 'example', user_id: 3
      } }
    end
  ...
  test 'should update the address' do
    ...
    patch address_path(addresses(:addresscurr)), params: { address: {
      ...
      kode_pos: 12_346, provinsi: 'malasyia', no_telepon: 1_234_567_899, kabupaten: 'dolok sihol'
    } }
    ...
    assert_equal 12_346, addresses(:addresscurr).reload.kode_pos
    assert_equal 1_234_567_899, addresses(:addresscurr).reload.no_telepon
  ...
  test 'should reject to update address for invalid information' do
    ...
    patch address_path(addresses(:addresscurr)), params: { address: {
      ...
      kode_pos: 1234, provinsi: 'may', no_telepon: 1_234_567, kabupaten: 'dol'
    } }
  ...
  test 'should reject update attribute for unpermited params' do
    ...
    patch address_path, params: { address: {
      alamat: 'malasyia', kelurahan: 'kuala lumpur', kecamatan: 'desa lau',
      kode_pos: 12_346, provinsi: 'malasyia', no_telepon: 1_234_567_899, kabupaten: 'dolok sihol', user_id: 12
    } }

class OrganizationDegreeListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @organization_degree_list.save
        format.html { redirect_to organization_degree_list_url(@organization_degree_list), notice: "Organization degree list was successfully created." }
  ...
  def update
    respond_to do |format|
      if @organization_degree_list.update(organization_degree_list_params)
        format.html { redirect_to organization_degree_list_url(@organization_degree_list), notice: "Organization degree list was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to organization_degree_lists_url, notice: "Organization degree list was successfully destroyed." }

  ...
  def create
    ...
    respond_to do |format|
      if @language_degree_list.save
        format.html do
          redirect_to language_degree_list_url(@language_degree_list),
                      notice: 'Language degree list was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @language_degree_list.update(language_degree_list_params)
        format.html do
          redirect_to language_degree_list_url(@language_degree_list),
                      notice: 'Language degree list was successfully updated.'
        end

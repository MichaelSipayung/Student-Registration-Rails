  ...
  def create
    ...
    respond_to do |format|
      if @high_school_major.save
        format.html { redirect_to high_school_major_url(@high_school_major), notice: "High school major was successfully created." }
  ...
  def update
    respond_to do |format|
      if @high_school_major.update(high_school_major_params)
        format.html { redirect_to high_school_major_url(@high_school_major), notice: "High school major was successfully updated." }
